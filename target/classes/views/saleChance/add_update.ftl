...
<html>
    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            ...
            <#-- 设置被编辑用户对应的指派人  -->
            <input type="hidden" name="saleChanceId" value="${(saleChance.assignMan)!}">

            <div class="layui-form-item layui-row layui-col-xs12">
                <label class="layui-form-label">客户名称</label>
                <div class="layui-input-block">
                    <#-- ${(saleChance.customerName)!}该方式用于获取请求域中的saleChance属性值，使用对象的指定属性进行填充value属性的值，
                    并使用 “!” 进行非空的判断  -->
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入机会描述信息" name="description" value="${(saleChance.description)!}" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item layui-row layui-col-xs12">
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                <div class="layui-input-block">
                    ...
                    <button class="layui-btn layui-btn-lg layui-btn-normal" id="closeeBtn">取消</button>
                </div>
            </div>
        </form>
